# Minotaur Game
- By Andrew Tsai, Nicholas Xavier, Lenore Chen, Shaqil Rahemtulla, Kevin Cai, Wayne Chen

### Notes

- The game compiles on Windows and Mac, but not on Linux.

### Responsibilities
Andrew Tsai
  - UI: HUD, mouse gestures, keyboard/mouse control
  - UX: Help, Tutorial, Story
  - Parallax background, BFS pathfinding, delay-agnostic design
